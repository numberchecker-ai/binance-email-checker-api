// Binance Email Checker API — .NET 6+ example. Docs: https://docs.numberchecker.ai/binance-email-checker
using System;
using System.IO;
...
class NumberChecker
{
    ...
    const string Type = "binance_email";
    ...
    {
        using var file = new ByteArrayContent(File.ReadAllBytes("examples/emails.txt"));
        var form = new MultipartFormDataContent();
        form.Add(file, "file", "emails.txt");
