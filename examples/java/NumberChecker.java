// Binance Email Checker API — Java 11+ example. Docs: https://docs.numberchecker.ai/binance-email-checker
...
public class NumberChecker {
    ...
    static final String TYPE = "binance_email";
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] fileBytes = Files.readAllBytes(Path.of("examples/emails.txt"));
        var createReq = HttpRequest.newBuilder(URI.create(BASE + "/v1/tasks"))
                .header("X-API-Key", KEY)
                .header("Content-Type", "multipart/form-data; boundary=" + boundary)
                .POST(multipart(boundary, fileBytes, "emails.txt", "task_type", TYPE))
                .build();
