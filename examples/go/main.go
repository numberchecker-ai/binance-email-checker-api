// Binance Email Checker API — Go example. Docs: https://docs.numberchecker.ai/binance-email-checker
package main
...
func main() {
	t, err := post("/v1/tasks", map[string]string{"task_type": taskType}, "examples/emails.txt")
	if err != nil {
		panic(err)
	}
